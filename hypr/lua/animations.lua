--------------------------------------------------------------------------------
-- Hyprland — animations.lua (was conf/animations/animations_fast.conf)
-- name "Fast"
--------------------------------------------------------------------------------
...
-- Apple's signature easing — fluid, gentle settle (cubic-bezier(.32,.72,0,1)).
hl.curve("apple", { type = "bezier", points = { { 0.32, 0.72 }, { 0, 1 } } })

hl.animation({ leaf = "windows", enabled = true, speed = 4, bezier = "apple", style = "popin 88%" })
